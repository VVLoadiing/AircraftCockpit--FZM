...
/**
 * HudChip — HUD 提示标签
 * 来源：UI设计系统规范.md 第 7.8 节（.hud-chip）
 * 小切角 + 半透底。
 */
...
<template>
  <span class="fzm-hud-chip" :class="type ? `is-${type}` : ''">
    <slot />
  </span>
</template>
